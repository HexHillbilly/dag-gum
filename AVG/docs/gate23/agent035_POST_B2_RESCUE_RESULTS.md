# agent-035 (post-B2) — Cross-Fixture Rescue Gate — GATE REPORT
...
bailout (the B1 retarget to active_loop_ids removed the batch-017 EOS-death
mechanism).

## Notes / caveats

- Sampling rescue results measured on the identical committed controller
  (`f890a42`) via scripts/measure_agent035_kickstart_sampling.py.
