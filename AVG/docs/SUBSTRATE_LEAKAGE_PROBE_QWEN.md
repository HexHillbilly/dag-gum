# DS-020 Substrate-Leakage Measurement Probe
...
| Runtime (wall clock) | 1571.3 s (26.2 min) |
...
- Run A SHA-256: `1507dd0cb15685dfc0ffd15a8cc8911528b1bff9a09c2d6720d53e3d0af46d4d`
- Run B SHA-256: `1507dd0cb15685dfc0ffd15a8cc8911528b1bff9a09c2d6720d53e3d0af46d4d`
...
|-----------|------|--------|-----|
| dormant | 0.8352 | 1.0000 | 1.0000 |
| active | 0.8352 | 1.0000 | 1.0000 |
...
| Condition | Mean | Median | p90 |
|-----------|------|--------|-----|
| dormant | 0.8869 | 0.8815 | 1.0000 |
| active | 0.8869 | 0.8815 | 1.0000 |
...
| Condition | Mean | Median | p90 |
|-----------|------|--------|-----|
| dormant | 0.9587 | 0.9565 | 1.0000 |
| active | 0.9587 | 0.9565 | 1.0000 |
...
| Condition | Mean | Median | p90 |
|-----------|------|--------|-----|
| dormant | 0.8743 | 0.8824 | 0.9314 |
| active | 0.8743 | 0.8824 | 0.9314 |
...
- In `t2s_degenerate`, dormant mean Distinct-2 was 0.8352 (median 1.0000, p90 1.0000); active mean Distinct-2 was 0.8352 (median 1.0000, p90 1.0000).
- In `t2s_degenerate`, dormant mean CTR was 0.8869 (median 0.8815, p90 1.0000); active mean CTR was 0.8869 (median 0.8815, p90 1.0000).
...
- In `valid_subset_200`, dormant mean Distinct-2 was 0.9587 (median 0.9565, p90 1.0000); active mean Distinct-2 was 0.9587 (median 0.9565, p90 1.0000).
- In `valid_subset_200`, dormant mean CTR was 0.8743 (median 0.8824, p90 0.9314); active mean CTR was 0.8743 (median 0.8824, p90 0.9314).
...
- Results JSONL: `docs/substrate_leakage_qwen_results.jsonl`
