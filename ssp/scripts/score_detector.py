...
SUPERSEDED by scripts/detector.py (the variance-aware trained classifier), which
is the honest detection score. This proxy is kept as the reference GLTR-style
measure it was in SCP Phase 4.
